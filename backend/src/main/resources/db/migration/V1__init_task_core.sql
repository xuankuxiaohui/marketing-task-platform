...
ALTER TABLE task_step             MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE task_step_platform    MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE user_task_instance    MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE task_filter           MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE task_platform         MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE user_task_step_progress MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT;
